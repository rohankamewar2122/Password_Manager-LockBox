    ...
    return (
        <>
            ...
            <div className=" p-3 md:mycontainer min-h-[88.2vh] ">
                ...
                <p className='text-green-900 text-lg text-center'>All Your Logins, One Secure Place.</p>
                ...
                <div className="passwords">
                    <h2 className='font-bold text-2xl py-4'>Your Login Credentials</h2>
                    {passwordArray.length === 0 && <div> No Saved Usernames & Passwords</div>}
                                    ...
                                    <td className='py-2 border border-white text-center'>
                                        <div className='flex items-center justify-center '>
                                            ...
                                            <div className='lordiconcopy size-7 cursor-pointer' onClick={() => { copyText(item.site) }}>
                                                <lord-icon
                                                    style={{ "width": "25px", "height": "25px", "paddingTop": "3px", "paddingLeft": "8px" }}
